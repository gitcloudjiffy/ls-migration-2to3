...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Dedicated Servers | Frankfurt, Germany | Leapswitch Networks</title>
            ...
            <div class="container">
              <div class="span7">
                <div class="banner-text">
                  <h1><span class="h5">Frankfurt, Germany</span></h1>
                  <?php include("../../banner-content/dedicated-banner.php"); ?>
                  <a href="asheville-usa/dedicated-servers/index.php#plan" type="button" class="btn btn-primary btn-lg">View Plans</a>
                </div>
              </div>
              <div class="span5"></div>
            </div>
        ...
        <form action="" id="countrybox">
          ...
          <select onchange="location = this.options[this.selectedIndex].value;">
            ...
            <optgroup label="Europe">
              ...
              <option value="frankfurt-germany/dedicated-servers/index.php" selected>Frankfurt, Germany</option>
            </optgroup>
                    ...
                    if ($_POST["contact-hide"] == "check") {
                        ...
                        if(empty($err)){
                            ...
                            <html>
                              ...
                              <body>
                                <p>You have received a new Customization Request from Asheville, on your website www.leapswitch.com dedicated form. </p>
                                <table>
            ...
            <div class="container-fluid">
              <div class="row-fluid">
                <div class="span6 link-box nomargin">
                  <span class="box-heading">Move to lightning fast<br>Cloud Server<br><a href="frankfurt-germany/managed-vps-hosting/linux.php" class="btn btn-primary btn-lg">Managed Linux Cloud Server</a></span>
                </div>
                  <div class="span6 link-box nomargin gray-border-left">
                    <span class="box-heading">Need Lighting-fast<br>Self managed Linux hosting?<br><a href="frankfurt-germany/unmanaged-vps-hosting/linux.php" class="btn btn-primary btn-lg">Self-Managed Linux Cloud Servers</a></span>
                  </div>
                </div>
              </div>
            </div>
