...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Managed Linux SSD Cloud Server | cPanel | Virtualmin | Frankfurt, Germany | Leapswitch Networks</title>
            ...
            <div class="container">
              <div class="span8">
                <div class="banner-text">
                  <h1><span class="h5">Linux Managed Cloud Server - Frankfurt, Germany</span></h1>
                  <?php include("../../banner-content/linux-vps-banner.php"); ?>
                  <a href="frankfurt-germany/managed-vps-hosting/linux.php#plan" type="button" class="btn btn-primary btn-lg">View Plans</a>
                </div>
              </div>
              <div class="span4"></div>
            </div>
        ...
        <form action="" id="countrybox">
          ...
          <select onchange="location = this.options[this.selectedIndex].value;">
            ...
            <optgroup label="Europe">
              ...
              <option value="frankfurt-germany/managed-vps-hosting/linux.php" selected>Frankfurt, Germany</option>
            </optgroup>
          ...
          <div class="container boxlink">
            <div class="container-fluid">
              <div class="row-fluid">
                ...
                <span class="box-heading">Need Lighting-fast Self managed Linux hosting?<br><a href="frankfurt-germany/unmanaged-vps-hosting/linux.php" class="btn btn-primary btn-lg">Self-Managed Linux Cloud Servers</a></span> </div>
              </div>
            </div>
          </div>
        </section>
