...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Managed Linux SSD Cloud Servers | cPanel | Virtualmin | Dallas, TX | Leapswitch Networks</title>
    ...
    <div class="page_container">
            ...
            <div class="container">
              <div class="span8">
                <div class="banner-text">
                  <h1><span class="h5">Linux Managed Cloud Server - Dallas, USA</span></h1>
                  <?php include("../../banner-content/linux-vps-banner.php"); ?>
                  <a href="dallas-usa/managed-vps-hosting/linux.php#plan" type="button" class="btn btn-primary btn-lg">View Plans</a>
                </div>
              </div>
              <div class="span4"></div>
            </div>
      ...
      <div class="wrap">
        ...
        <form action="" id="countrybox">
          ...
          <select onchange="location = this.options[this.selectedIndex].value;">
            ...
            <optgroup label="USA">
              ...
              <option value="dallas-usa/managed-vps-hosting/linux.php" selected>Dallas, TX</option>
        ...
        <!--  Other Plans  -->
        <section class="bg-white quick-link">
          <div class="container boxlink">
            <div class="container-fluid">
              <div class="row-fluid">
                <div class="span6 link-box nomargin">
                  <span class="box-heading">Hosting PHP websites<br>for your customers?<br><a href="dallas-usa/reseller-web-hosting/linux.php" class="btn btn-primary btn-lg">Reseller Linux Web Hosting</a></span> </div>
                  <div class="span6 link-box nomargin gray-border-left">
                    <span class="box-heading">Need Lighting-fast Self managed<br>Linux hosting?<br><a href="dallas-usa/unmanaged-vps-hosting/linux.php" class="btn btn-primary btn-lg">Self-Managed Linux Cloud Servers</a></span></div>
                  </div>
                </div>
              </div>
        </section>
