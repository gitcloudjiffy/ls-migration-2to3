...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Dallas, TX | Shared Hosting | Reseller Hosting | Cloud Servers | Leapswitch Networks</title>
                        ...
                        <div class="container">
                            <div class="span7">
                                <div class="banner-text dark-text">
                                    <h1>Dallas, USA</h1>
                                    <a href="dallas-usa/index.php#plan" type="button" class="btn btn-primary btn-lg">Get Started</a>
                                </div>
                            </div>
                            <div class="span5"></div>
                        </div>
                ...
                <form action="" id="countrybox">
                    ...
                    <select onchange="location = this.options[this.selectedIndex].value;">
                        ...
                        <optgroup label="USA">
                            ...
                            <option value="dallas-usa/index.php" selected>Dallas, TX</option>
                ...
                <section class="service_area bg-white" id="plan">
                    <div class="container">
                        <div class="container-fluid">
                            <div class="row-fluid">
                                <div class="">
                                    <h2 class="title"><span>Dallas, TX, USA</span></h2>
                                    <p>LeapSwitch Networks provides a high performance and secure platform for you to host your website/application/blogs, email, etc. at an affordable price. Our Data Center in Dallas - Nested in the rolling prairies of North central Texas, caters to the Middle and Mountain region of the USA. Our datacenter SSAE16 certified. This, coupled with our Tier 1 fiber optic connectivity caters to a wide range of solution whilst keeping your data safe and secure.</p>
                                    <div class="line"></div>
                                    <div class="row-fluid service_inner">
                                        <div class="span6">
                                            <div class="service_item">
                                                ...
                                                <p class="text-right"><span><a href="dallas-usa/shared-web-hosting/linux.php"><i class="lnr lnr-magnifier"></i>View Plans</a></span></p>
                                            </div>
                                        </div>
                                        <div class="span6">
                                            <div class="service_item">
                                                ...
                                                <p class="text-right"><span><a href="dallas-usa/reseller-web-hosting/linux.php"><i class="lnr lnr-magnifier"></i>View Plans</a></span></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row-fluid service_inner">
                                        <div class="span6">
                                            <div class="service_item">
                                                ...
                                                <p class="text-right"><span><a href="dallas-usa/managed-vps-hosting/linux.php"><i class="lnr lnr-magnifier"></i>View Plans</a></span></p>
                                            </div>
                                        </div>
                                        <div class="span6">
                                            <div class="service_item">
                                                ...
                                                <p class="text-right"><span><a href="dallas-usa/unmanaged-vps-hosting/linux.php"><i class="lnr lnr-magnifier"></i>View Plans</a></span></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="container">
                        <div class="container-fluid">
                            <div class="section-title textcenter">
                                   <h2>Dallas Data Center</h2>
                            </div>
                            <div class='row-fluid product-wrapper'>
                                <div class="span6">
                                    <label for="" class="labeltitle">About DC</label>
                                    <p>Our Dallas Data Center is SSAE16 certified with an uptime guarantee to keep mission-critical applications up and running 24/7.</p>
                                </div>
                                <div class="span6">
                                    <label for="" class="labeltitle">Our Features</label>
                                    <p>To highlight a few of the key features of our infrastructure:</p>
                                    <ol class="dc-values-list">
                                        <li>Environmentally controlled, secure data center space</li>
                                        <li>Second-largest Internet peering exchange in the U.S. in Los Angeles.</li>
                                        <li>True redundant power and multi-homed connectivity from leading Tier 1 carriers.</li>
                                        <li>State-of-the-art physical security, networks, HVAC, connectivity, capacities.</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
