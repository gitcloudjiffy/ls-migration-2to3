...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Dedicated Servers | Lisbon, Portugal | Leapswitch Networks</title>
    ...
    <div class="page_container">
                    ...
                    <div class="container">
                      <div class="span7">
                        <div class="banner-text">
                          <h1><span class="h5">Lisbon, Portugal</span></h1>
                          <?php include("../../banner-content/dedicated-banner.php"); ?>
                          <a href="lisbon-portugal/dedicated-servers/index.php#plan" type="button" class="btn btn-primary btn-lg">View Plans</a>
                        </div>
                      </div>
                      <div class="span5"></div>
                    </div>
      ...
      <div class="wrap">
            ...
            <select onchange="location = this.options[this.selectedIndex].value;">
               <option value="" disabled selected="">Please select your location</option>
                ...
                <optgroup label="Europe">
                  <option value="lisbon-portugal/dedicated-servers/index.php" selected>Lisbon, Portugal</option>
                          ...
                          if ($_POST["contact-hide"] == "check") {
                              ...
                              if(empty($err)){
                                  ...
                                  <html>
                                    ...
                                    <body>
                                      <p>You have received a new Customization Request from Lisbon, on your website www.leapswitch.com dedicated form.</p>
                                      <table>
        ...
        <!-- All plans include -->
        <section class="bg-faint plans-include">
          <div class="container">
            <div class="container-fluid">
