...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Self-Managed Linux Cloud Server | Lisbon, Portugal | Leapswitch Networks</title>
            ...
            <div class="container">
              <div class="span8">
                <div class="banner-text">
                  <h1><span class="h5">Linux Self-Managed Cloud Server - Lisbon, Portugal</span></h1>
                  <?php include("../../banner-content/linux-vps-banner.php"); ?>
                  <a href="lisbon-portugal/unmanaged-vps-hosting/linux.php#plan" type="button" class="btn btn-primary btn-lg">View Plans</a>
                </div>
              </div>
              <div class="span4"></div>
            </div>
      ...
      <div class="wrap">
        ...
        <form action="" id="countrybox">
              ...
              <select onchange="location = this.options[this.selectedIndex].value;">
                  ...
                  <option value="lisbon-portugal/unmanaged-vps-hosting/linux.php" selected>Lisbon, Portugal</option>
            ...
            <div class="container-fluid">
              <div class="row-fluid">
                  <div class="span6 link-box nomargin">
                    <span class="box-heading">Hosting PHP websites<br>for your customers?<br><a href="lisbon-portugal/reseller-web-hosting/linux.php" class="btn btn-primary btn-lg">Reseller Linux Web Hosting</a></span>
                  </div>
                  <div class="span6 link-box nomargin gray-border-left">
                    <span class="box-heading">Move to lightning fast<br>SSD based Servers<br><a href="lisbon-portugal/managed-vps-hosting/linux.php" class="btn btn-primary btn-lg">Managed Linux Cloud Servers</a></span>
                  </div>
              </div>
              </div>
            </div>
