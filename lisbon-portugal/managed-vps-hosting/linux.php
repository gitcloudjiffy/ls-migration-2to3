...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Managed Linux SSD Cloud Server | cPanel | Virtualmin | Lisbon, Portugal | Leapswitch Networks</title>
            ...
            <div class="container">
              <div class="span8">
                <div class="banner-text">
                  <h1><span class="h5">Linux Managed Cloud Server - Lisbon, Portugal</span></h1>
                  <?php include("../../banner-content/linux-vps-banner.php"); ?>
                  <a href="lisbon-portugal/managed-vps-hosting/linux.php#plan" type="button" class="btn btn-primary btn-lg">View Plans</a>
                </div>
              </div>
              <div class="span4"></div>
            </div>
        ...
        <form action="" id="countrybox">
          <label for="">Select Your Location</label>
                    <select onchange="location = this.options[this.selectedIndex].value;">
                        ...
                        <option value="lisbon-portugal/managed-vps-hosting/linux.php" selected>Lisbon, Portugal</option>
          ...
          <div class="container boxlink">
            <div class="container-fluid">
              <div class="row-fluid">
                    ...
                    <span class="box-heading">We can give you more power and resources<br><a href="lisbon-portugal/dedicated-servers/index.php" class="btn btn-primary btn-lg">Dedicated Servers</a></span> </div>
                    <div class="span6 link-box nomargin gray-border-left">
                    <span class="box-heading">Move to lightning fast Cloud Servers<br><a href="lisbon-portugal/unmanaged-vps-hosting/linux.php" class="btn btn-primary btn-lg">Self-Managed Linux VPS</a></span> </div>
              </div>
            </div>
          </div>
        </section>
