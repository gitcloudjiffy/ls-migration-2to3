...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Self-Managed Linux Cloud Servers | Barcelona, Spain | Leapswitch Networks</title>
    ...
    <div class="page_container">
            ...
            <div class="container">
              <div class="span8">
                <div class="banner-text">
                  <h1><span class="h5">Linux Self-Managed Cloud Servers - Barcelona, Spain</span></h1>
                      <?php include("../../banner-content/linux-vps-banner.php"); ?>
                  <a href="barcelona-spain/unmanaged-vps-hosting/linux.php#plan" type="button" class="btn btn-primary btn-lg">View Plans</a>
                </div>
              </div>
              <div class="span4"></div>
            </div>
      ...
      <div class="wrap">
        ...
        <form action="" id="countrybox">
          ...
          <select onchange="location = this.options[this.selectedIndex].value;">
            ...
            <optgroup label="Europe">
              <option value="barcelona-spain/unmanaged-vps-hosting/linux.php" selected>Barcelona, Spain</option>
              ...
              <option value="frankfurt-germany/unmanaged-vps-hosting/linux.php">Frankfurt, Germany</option>
            </optgroup>
          ...
          <div class="container">
            <div class="container-fluid">
              <div class='product-wrapper' >
                ...
                <?php include("../../product-plan/selfmanaged-linux-cloud-server-allPlan.php"); ?>
              </div>
            </div>
          </div>
        </section>
              ...
              <div class="features">
                <div class="row-fluid">
                  ...
                  <div class="row-fluid gray-border-bottom">
                    ...
                    <div class="span4 gray-border-left">
                      <div class="featureicon"><img src="img/features/technical-support.svg" alt="24/7 Infrastructure & Network support" style="height: 70px;"></div>
        ...
        <section class="bg-gray plans-include">
          <div class="container">
            <div class="container-fluid plans-include">
            ...
            <div class="container-fluid">
              <div class="row-fluid">
                ...
                <div class="span6 link-box nomargin gray-border-left">
                  <span class="box-heading">Move to lightning fast<br>SSD based Servers<br><a href="barcelona-spain/managed-vps-hosting/linux.php" class="btn btn-primary btn-lg">Managed Linux Cloud Servers</a></span>
                </div>
              </div>
            </div>
          </div>
