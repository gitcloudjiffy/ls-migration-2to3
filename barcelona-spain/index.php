...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Barcelona, Spain | Shared Hosting | Reseller Hosting | Cloud Servers | Leapswitch Networks</title>
                        ...
                        <div class="container">
                            <div class="span7">
                                <div class="banner-text dark-text">
                                    ...
                                    <a href="barcelona-spain/index.php#plan" type="button" class="btn btn-primary btn-lg">Get Started</a>
                                </div>
                            </div>
                            <div class="span5"></div>
                        </div>
                ...
                <form action="" id="countrybox">
                    ...
                    <select onchange="location = this.options[this.selectedIndex].value;">
                        ...
                        <optgroup label="Europe">
                            <option value="barcelona-spain/index.php" selected>Barcelona, Spain</option>
                ...
                <section class="service_area bg-white" id="plan">
                    <div class="container">
                        <div class="container-fluid">
                            <div class="row-fluid" >
                                <div class="" >
                                    <h2 class="title"><span>Barcelona, Spain</span></h2>
                                    <p>LeapSwitch Networks provides a high performance and secure platform for you to host your website/application/ blogs, email, etc. at an affordable price. Our Data Center in Barcelona - the cosmopolitan capital of Spain’s Catalonia region, known for its art and architecture caters to the Western Europe. Our datacenter's strategic location ensures we provide a wide range of solution whilst keeping your data safe and secure.</p>
                                    <div class="line"></div>
                                    <div class="row-fluid service_inner">
                                        <div class="span6">
                                            <div class="service_item">
                                                ...
                                                <p class="text-right"><span><a href="barcelona-spain/shared-web-hosting/linux.php"><i class="lnr lnr-magnifier"></i>View Plans</a></span></p>
                                            </div>
                                        </div>
                                        <div class="span6">
                                            <div class="service_item">
                                                ...
                                                <p class="text-right"><span><a href="barcelona-spain/reseller-web-hosting/linux.php"><i class="lnr lnr-magnifier"></i>View Plans</a></span></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row-fluid service_inner">
                                        <div class="span6">
                                            <div class="service_item">
                                                ...
                                                <p class="text-right"><span><a href="barcelona-spain/managed-vps-hosting/linux.php"><i class="lnr lnr-magnifier"></i>View Plans</a></span></p>
                                            </div>
                                        </div>
                                        <div class="span6">
                                            <div class="service_item">
                                                ...
                                                <p class="text-right"><span><a href="barcelona-spain/unmanaged-vps-hosting/linux.php"><i class="lnr lnr-magnifier"></i>View Plans</a></span></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="container">
                        <div class="container-fluid">
                            <div class="section-title textcenter">
                                   <h2>Barcelona - Data Center</h2>
                            </div>
                            <div class='row-fluid product-wrapper'>
                                <div class="span6">
                                    <label for="" class="labeltitle">Our Technology</label>
                                    <p>We believe in using the latest technology to ensure top performance for all our clients.</p>
                                    <p>Our company is constantly updating our hardware - whether it be network equipment or servers - to decrease the likelihood of hardware failure and keep up with the growing IT demands of our clients.
                                    </p>
                                </div>
                                <div class="span6">
                                    <label for="" class="labeltitle">Our Team</label>
                                    <p>Our 24/7/365 team of highly qualified level three system administrators run our technical support department to a new standard in the hosting industry. With rapid response times, an amazing work ethic, and a wide range of knowledge, our support team is unmatched in terms of quality and helpfulness.</p>
                                </div>
                            </div>
                        </div>
                    </div>
