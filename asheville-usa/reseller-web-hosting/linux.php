...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>SSD Linux Reseller Hosting | Asheville, NC, USA | Leapswitch Networks </title>
            ...
            <div class="container">
              <div class="span7">
                <div class="banner-text">
                  <h1><span class="h5">Linux Reseller Hosting - Asheville, USA</span></h1>
                  <?php include("../../banner-content/linux-reseller-hosting-banner.php"); ?>
                  <a href="asheville-usa/reseller-web-hosting/linux.php#plan" type="button" class="btn btn-primary btn-lg">View Plans</a>
                </div>
              </div>
              <div class="span5"></div>
            </div>
      ...
      <div class="wrap">
        ...
        <form action="" id="countrybox">
          ...
          <select onchange="location = this.options[this.selectedIndex].value;">
            ...
            <optgroup label="USA">
              <option value="asheville-usa/reseller-web-hosting/linux.php" selected>Asheville, NC</option>
            ...
            <div class="container-fluid">
              <div class="row-fluid">
                <div class="span6 link-box nomargin">
                  <span class="box-heading">Hosting ASP.NET websites<br>for your customers?<br><a href="asheville-usa/reseller-web-hosting/windows.php" class="btn btn-primary btn-lg">Reseller Windows Web Hosting</a></span>
                </div>
                <div class="span6 link-box nomargin gray-border-left">
                  <span class="box-heading">Redefined Cloud Services<br>for Enterprises<br><a href="asheville-usa/managed-vps-hosting/linux.php" class="btn btn-primary btn-lg">Managed Linux Cloud Server</a></span>
                </div>
              </div>
            </div>
          </div>
