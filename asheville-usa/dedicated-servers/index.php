...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Dedicated Servers | Asheville, NC, USA | Leapswitch Networks</title>
            ...
            <div class="container">
              <div class="span7">
                <div class="banner-text">
                  <h1><span class="h5">Asheville, USA</span></h1>
      ...
      <div class="wrap">
        ...
        <form action="" id="countrybox">
          ...
          <select onchange="location = this.options[this.selectedIndex].value;">
            ...
            <optgroup label="USA">
              <option value="asheville-usa/dedicated-servers/index.php" selected>Asheville, NC</option>
            ...
            <div class="container-fluid">
              <div class="row-fluid">
                <div class="span6 link-box nomargin">
                  <span class="box-heading">Move to lightning fast<br>SSD based Servers<br><a href="asheville-usa/managed-vps-hosting/linux.php" class="btn btn-primary btn-lg">Managed Linux Cloud Server</a></span>
                </div>
