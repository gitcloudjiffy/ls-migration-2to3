...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Dedicated Servers | India - Mumbai | Managed | Linux | Windows - Leapswitch Networks</title>
    <?php include("../../base-url.php");?>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Leapswitch offers Dedicated Servers in Mumbai, India with Premium Network, Latest Servers and managed services.">
            ...
            <div class="container">
              <div class="span7">
                <div class="banner-text">
                  <h1><span class="h5">Mumbai, India</span></h1>
                  <?php include("../../banner-content/dedicated-banner.php"); ?>
                  <a href="mumbai-india/dedicated-servers/index.php#plan" type="button" class="btn btn-primary btn-lg">View Plans</a>
                </div>
              </div>
              <div class="span5"></div>
            </div>
        ...
        <form action="" id="countrybox">
          ...
          <select onchange="location = this.options[this.selectedIndex].value;">
            ...
            <optgroup label="India">
              ...
              <option value="mumbai-india/dedicated-servers/index.php" selected>Mumbai, MH</option>
                ...
                <div class='product-line row-fluid tab-product-line'>
                  ...
                  <div class='package span3'>
                    ...
                    <ul>
                      ...
                      <!--<li>
                        <strong>192 GB</strong> RAM Capacity
                      </li> -->
                      <li>
                        <strong>Single</strong> Processor
                      </li>
                      <li>
                        <strong>6</strong> cores (12 vCPU)<!-- Physical Cores -->
                      </li>
                      <!--<li>
                        <strong>12</strong> vCPU (Logical Cores)
                      </li> -->
                      <li>
                        <strong>1TB</strong> HDD (upto 8)
                      </li>
                      <!--<li>
                        <strong>4 or 8</strong> Max HDD or SSD
                      </li> -->
                      <li>
                        <strong>100 mbps</strong> Port speed
                      </li>
                ...
                <div class='product-line row-fluid tab-product-line'>
                  <div class='package span3'>
                    ...
                    <ul>
                      ...
                      <li>
                        <strong>10</strong> cores (10 vCPU)<!-- Physical Cores -->
                      </li>
                      <li>
                        <strong>1TB</strong> HDD (upto 8)
                      </li>
                ...
                <div class='product-line row-fluid tab-product-line' id="more">
                  <div class='package span3'>
                    ...
                    <div class='trial'><?php
                      ...
                      {
                      echo '
                      <a href="https://service.leapswitch.com/cart.php?a=add&pid=754&currency=2" class="orderbutton">CONFIGURE NOW</a>
                      ';
                      }
                      else
                      {
                      echo '
                      <a href="https://service.leapswitch.com/cart.php?a=add&pid=754&currency=1" class="orderbutton">CONFIGURE NOW</a>
                      ';
                      }
                      ?>
                    </div>
                    ...
                    <ul>
                      ...
                      <li>
                        <strong>6</strong> cores (12 Threads)<!-- Physical Cores -->
                      </li>
                      <li>
                        <strong>1TB</strong> HDD (upto 8)
                      </li>
                  ...
                  <div class='package span3'>
                    ...
                    <div class='trial'><?php
                      ...
                      {
                      echo '
                      <a href="https://service.leapswitch.com/cart.php?a=add&pid=761&currency=2" class="orderbutton">CONFIGURE NOW</a>
                      ';
                      }
                      else
                      {
                      echo '
                      <a href="https://service.leapswitch.com/cart.php?a=add&pid=761&currency=1" class="orderbutton">CONFIGURE NOW</a>
                      ';
                      }
                      ?>
                    </div>
