...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Self-Managed Cloud Linux Cloud Server | Pune, India | Leapswitch Networks</title>
                ...
                <div class="container">
                  <div class="span8">
                    <div class="banner-text">
                      <h1><span class="h5">Linux Self-Managed Cloud Server - Pune, India</span></h1>
                      <?php include("../../banner-content/linux-vps-banner.php"); ?>
                      <a href="pune-india/unmanaged-vps-hosting/linux.php#plan" type="button" class="btn btn-primary btn-lg">View Plans</a>
                    </div>
                  </div>
                  <div class="span4"></div>
                </div>
      ...
      <div class="wrap">
          ...
          <form action="" id="countrybox">
              ...
              <select onchange="location = this.options[this.selectedIndex].value;">
                  ...
                  <option value="pune-india/unmanaged-vps-hosting/linux.php" selected>Pune, MH</option>
                  </optgroup>
              </select>​
          </form>
          <!--  Product Plan -->
