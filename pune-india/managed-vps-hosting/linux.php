...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Managed Linux SSD Cloud Server | cPanel | Virtualmin | Pune, India | Leapswitch Networks</title>
            ...
            <div class="container">
              <div class="span8">
                <div class="banner-text">
                  <h1><span class="h5">Linux Managed Cloud Server - Pune, India</span></h1>
                  <?php include("../../banner-content/linux-vps-banner.php"); ?>
                  <a href="pune-india/managed-vps-hosting/linux.php#plan" type="button" class="btn btn-primary btn-lg">View Plans</a>
                </div>
              </div>
              <div class="span4"></div>
            </div>
        ...
        <form action="" id="countrybox">
          ...
          <select onchange="location = this.options[this.selectedIndex].value;">
            ...
            <optgroup label="India">
              <option value="pune-india/managed-vps-hosting/linux.php" selected>Pune,MH</option>
            </optgroup>
          </select>​
        </form>
        <!--  Product Plan -->
          ...
          <div class="container boxlink">
            <div class="container-fluid">
              <div class="row-fluid">
                ...
                <span class="box-heading">We can give you more power<br>and resources<br><a href="pune-india/dedicated-servers/index.php" class="btn btn-primary btn-lg">Dedicated Servers</a></span> </div>
                <div class="span6 link-box nomargin gray-border-left">
                <span class="box-heading"><span class="box-heading">Need Lighting-fast Self managed<br>Linux hosting?<br><a href="pune-india/unmanaged-vps-hosting/linux.php" class="btn btn-primary btn-lg">Self-Managed Linux Cloud Servers</a></span> </div>
              </div>
            </div>
          </div>
        </section>
