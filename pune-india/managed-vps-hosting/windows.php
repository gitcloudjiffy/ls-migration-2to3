...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Managed Windows Cloud Servers | Hyper-V | Pune, India | Leapswitch Networks</title>
    ...
    <div class="page_container">
            ...
            <div class="container">
              <div class="span8">
                <div class="banner-text">
                  <h1><span class="h5">Windows Managed Cloud Server - Pune, India</span></h1>
                    <?php include("../../banner-content/windows-vps-banner.php"); ?>
                  <a href="pune-india/managed-vps-hosting/windows.php#plan" type="button" class="btn btn-primary btn-lg">View Plans</a>
                </div>
              </div>
              <div class="span4"></div>
            </div>
      ...
      <div class="wrap">
            ...
            <form action="" id="countrybox">
              ...
              <select onchange="location = this.options[this.selectedIndex].value;">
                ...
                <optgroup label="India">
                  <option value="pune-india/managed-vps-hosting/windows.php" selected>Pune, MH</option>
              ...
              <div class="container">
                <div class="container-fluid">
                  <div class='product-wrapper' >
                    ...
                    <?php include("../../product-plan/managed-windows-cloud-server-allPlan.php"); ?>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section class="bg-gray plans-include">
              <div class="container">
                <div class="container-fluid">
                  ...
                  <div class="row-fluid benefits">
                    <div class="span4"><div class="all-plans-item"><div class="iconcheck"></div><div class="commanpoint">Unlimited Domains hosting</div></div></div>
                    <div class="span4"><div class="all-plans-item"><div class="iconcheck"></div><div class="commanpoint">Unlimited Sub-Domains hosting</div></div></div>
                  ...
                  <div class="row-fluid benefits">
                    <div class="span4"><div class="all-plans-item"><div class="iconcheck"></div><div class="commanpoint">Unlimited MSSQL databases</div></div></div>
                  ...
                  <div class="row-fluid benefits">
                    <div class="span4"><div class="all-plans-item"><div class="iconcheck"></div><div class="commanpoint">IIS</div></div></div>
                ...
                <div class="container-fluid">
                  <div class="row-fluid">
                    <div class="span6 link-box nomargin">
                      <span class="box-heading">We can give you more power and resources<br><a href="pune-india/dedicated-servers/index.php" class="btn btn-primary btn-lg">Dedicated Servers</a></span> </div>
                      <div class="span6 link-box nomargin gray-border-left">
                        <span class="box-heading">Move to lightning fast Cloud Servers<br><a href="pune-india/unmanaged-vps-hosting/windows.php" class="btn btn-primary btn-lg">Self-Managed Windows Cloud Servers</a></span> </div>
                      </div>
                    </div>
              </div>
            </section>
            ...
            <!--  FAQ -->
            <?php include("../../faq/managed-vps-window-faq.php"); ?>
      </div>
    <!--//page_container-->
