...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Dedicated Servers | Managed | Linux | Windows | Leapswitch Networks</title>
            ...
            <div class="container">
              <div class="span7">
                <div class="banner-text">
                  <h1><span class="h5">Dedicated Servers</span></h1>
              ...
              <div class='product-wrapper row-fluid'>
                ...
                <div class='product-line row-fluid tab-product-line' id="more">
                    <div class='package span3'>
                      ...
                      echo '
                            ...
                            <ul>
                                ...
                                <li>
                                  <strong>10</strong> cores (20 vCPU)
                                </li>
                                <li>
                                  <strong>1TB</strong> HDD (upto 8)
                                </li>
                    ...
                    <div class='package span3'>
                              ...
                              <li>
                              <strong>12</strong> cores (24 vCPU)
                              </li>
                              <li>
                    ...
                    <div class='package brilliant span3'>
                        ...
                        <li>
                        <strong>16</strong> cores (32 vCPU)
                        </li>
                        <li>
                        <strong>2 x 1TB</strong> HDD (upto 8)
                        </li>
                    ...
                    <div class='package span3'>
                        ...
                        <li>
                        <strong>20</strong> cores (40 vCPU)
                        </li>
                        <li>
                        <strong>2 x 1TB</strong> HDD (upto 8)
                        </li>
                ...
                btnText.innerHTML = '<span class="see-plans">See more plans-include</span>';
        ...
        <section class="bg-white quick-links">
          <div class="container boxlink">
            <div class="container-fluid">
              ...
              <span class="box-heading">Move to lightning fast<br>SSD based Servers<br><a href="pune-india/managed-vps-hosting/linux.php" class="btn btn-primary btn-lg">Managed Linux Cloud Server</a></span> </div>
