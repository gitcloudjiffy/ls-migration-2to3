...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Dedicated Servers | India - Delhi | Managed | Linux | Windows - Leapswitch Networks</title>
    <?php include("../../base-url.php");?>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Leapswitch offers Dedicated Servers in Delhi, India with Premium Network, Latest Servers and managed services.">
            ...
            <div class="container">
              <div class="span7">
                <div class="banner-text">
                  <h1><span class="h5">Delhi, India</span></h1>
                  <?php include("../../banner-content/dedicated-banner.php"); ?>
                  <a href="delhi-india/dedicated-servers/index.php#plan" type="button" class="btn btn-primary btn-lg">View Plans</a>
                </div>
              </div>
              <div class="span5"></div>
            </div>
        ...
        <form action="" id="countrybox">
          ...
          <select onchange="location = this.options[this.selectedIndex].value;">
            ...
            <optgroup label="India">
              ...
              <option value="delhi-india/dedicated-servers/index.php" selected>Delhi, NCR</option>
            </optgroup>
          </select>​
        </form>
        <!--  Product Plan -->
                ...
                <div class='product-line row-fluid tab-product-line'>
                  ...
                  <div class='package span3'>
                    ...
                    <div class='trial'><?php
                      ...
                      {
                      echo '
                      <a href="https://service.leapswitch.com/cart.php?a=add&pid=748&currency=2" class="orderbutton">CONFIGURE NOW</a>
                      ';
                      }
                      else
                      {
                      echo '
                      <a href="https://service.leapswitch.com/cart.php?a=add&pid=748&currency=1" class="orderbutton">CONFIGURE NOW</a>
                      ';
                      }
                      ?>
                    </div>
