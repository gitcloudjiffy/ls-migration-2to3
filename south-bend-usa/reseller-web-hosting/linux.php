...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>SSD Linux Reseller Hosting | South Bend, IN | Leapswitch Networks</title>
            ...
            <div class="container">
              <div class="span7">
                <div class="banner-text">
                 <h1><span class="h5">Linux Reseller Hosting - South Bend, USA</span></h1>
                  <?php include("../../banner-content/linux-reseller-hosting-banner.php"); ?>
                  <a href="south-bend-usa/reseller-web-hosting/linux.php#plan" type="button" class="btn btn-primary btn-lg">View Plans</a>
                </div>
              </div>
              <div class="span5"></div>
            </div>
        ...
        <form action="" id="countrybox">
          ...
          <select onchange="location = this.options[this.selectedIndex].value;">
            ...
            <optgroup label="USA">
              ...
              <option value="south-bend-usa/reseller-web-hosting/linux.php" selected>South Bend, IN</option>
            ...
            <div class="container-fluid">
              <div class="row-fluid">
                  <div class="span6 link-box nomargin">
                    <span class="box-heading">Host your website with cPanel.<br><a href="south-bend-usa/shared-web-hosting/linux.php" class="btn btn-primary btn-lg">Shared Web Hosting</a></span>
                  </div>
                  <div class="span6 link-box nomargin gray-border-left">
                    <span class="box-heading">Redefined Cloud Services for Enterprises<br><a href="south-bend-usa/managed-vps-hosting/linux.php" class="btn btn-primary btn-lg">Managed Linux Cloud Servers</a></span>
                  </div>
              </div>
            </div>
          </div>
