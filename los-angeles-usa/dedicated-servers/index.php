...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Dedicated Servers | Los Angeles, CA | Leapswitch Networks</title>
                    ...
                    <div class="container">
                      <div class="span7">
                        <div class="banner-text">
                          <h1><span class="h5">Los-Angeles, USA</span></h1>
                          <?php include("../../banner-content/dedicated-banner.php"); ?>
                          <a href="los-angeles-usa/dedicated-servers/index.php#plan" type="button" class="btn btn-primary btn-lg">View Plans</a>
                        </div>
                      </div>
                      <div class="span5"></div>
                    </div>
            ...
            <select onchange="location = this.options[this.selectedIndex].value;">
               <option value="" disabled selected="">Please select your location</option>
                <optgroup label="USA">
                  ...
                  <option value="los-angeles-usa/dedicated-servers/index.php" selected>Los Angeles, CA</option>
                </optgroup>
                          ...
                          if ($_POST["contact-hide"] == "check") {
                              ...
                              if(empty($err)){
                                  ...
                                  <html>
                                    ...
                                    <body>
                                      <p>You have received a new Customization Request from Los Angeles, on your website www.leapswitch.com dedicated form.</p>
                                      <table>
